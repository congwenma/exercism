...
describe('List', function () {
  ...
  describe('append', function () {
    it('appends two empty lists', function () {
      ...
      // console.log('DEBUG', emptyList.values)
      // console.log('DEBUG', emptyList.append(emptyList).values)
    ...
    it('appends an empty list to a non-empty list', function () {
      ...
      // console.log('DEBUG - emptyList', emptyList.values)
      // console.log('DEBUG - nonEmptyList', nonEmptyList.values)
      // console.log('DEBUG', emptyList.append(nonEmptyList).values)
